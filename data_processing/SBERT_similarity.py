...
fine_tuning_articles = read_multiline_jsonl(fine_tuning_file)
print(f"Loaded {len(fine_tuning_articles)} fine-tuning articles.")

# Extract text content
preprocessed_texts = [article["original_text"] for article in preprocessed_articles]
fine_tuning_texts = [article["original_text"] for article in fine_tuning_articles]
...
fine_tuning_ids = [article["unique_id"] for article in fine_tuning_articles]
...
similarity_data = {
    ...
    "top_ids": top_ids,
    "fine_tuning_ids": fine_tuning_ids
}
